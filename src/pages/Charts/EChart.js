...
import FertChart from "../AllCharts/echart/fertchart";
        ...
        <div className="container-fluid">
              ...
              <div className="page-title-box">
                ...
                <ol className="breadcrumb mb-0">
                  <li className="breadcrumb-item">
                    <Link to="/#">SmartAcres</Link>
                  </li>
                  <li className="breadcrumb-item">
                    <Link to="/#">Charts</Link>
                  </li>
                  <li className="breadcrumb-item active">Fert Charts</li>
                </ol>
              </div>
            </Col>
          ...
          <Row>
            <Col lg="6">
              <Card>
                <CardBody>
                  <h4 className="mt-0 header-title mb-4">Species A</h4>
            ...
            <Col lg="6">
              <Card>
                <CardBody>
                  <h4 className="mt-0 header-title mb-4">Species B</h4>
                  <div id="line-chart" className="e-chart">
                    <FertChart />
                  </div>
                </CardBody>
          ...
          <Col lg="6">
              <Card>
                <CardBody>
                  <h4 className="mt-0 header-title mb-4">Rainfall and Precipitation</h4>
            ...
            <Col lg="6">
              <Card>
                <CardBody>
                  <h4 className="mt-0 header-title mb-4">Growth Rates</h4>
